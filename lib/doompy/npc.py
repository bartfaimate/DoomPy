...
class NPC(AnimatedSprite):
    def __init__(
        self,
        game,
        path=config.resource_root.joinpath("sprites/npc/soldier/0.png"),
        pos=(10.5, 5.5),
        scale=0.6,
        shift=0.38,
        animation_time=180,
...
class CacoDemonNPC(NPC):
    def __init__(
        self,
        game,
        path=config.resource_root.joinpath("sprites/npc/caco_demon/0.png"),
        pos=(10.5, 6.5),
        scale=0.7,
        shift=0.27,
        animation_time=250,
...
class CyberDemonNPC(NPC):
    def __init__(
        self,
        game,
        path=config.resource_root.joinpath("sprites/npc/cyber_demon/0.png"),
        pos=(11.5, 6.0),
        scale=1.0,
        shift=0.04,
        animation_time=210,
